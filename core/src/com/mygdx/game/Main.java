...
public class Main extends Game {
    ...
    public static Color getMiddleValue(Color color_1, Color color_2, float level) {
        return new Color(
                Math.abs(color_1.r + (color_2.r - color_1.r) * level),
                Math.abs(color_1.g + (color_2.g - color_1.g) * level),
                Math.abs(color_1.b + (color_2.b - color_1.b) * level),
                Math.abs(color_1.a + (color_2.a - color_1.a) * level));
    }
}